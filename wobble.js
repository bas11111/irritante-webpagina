...
const speed = 30; // speed of wobbling, lower is faster
const height = 6;  // height of wobbling in pixels
const alink = "website.html";  // page to link text to (set to ="" for no link)
